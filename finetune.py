...
if __name__ == '__main__':
    # python finetune.py --batch_size 20 --data data/penn 
    #   --dropouti 0.4 --dropouth 0.25 --seed 141 --epoch 500 --save PTB.pt
    ...
    try:
        ...
        for epoch in range(1, args.epochs+1):
            ...
            writer.add_scalar('Validation loss', loss_scalar, epoch)                
            writer.add_scalar('Validation ppl', math.exp(loss_scalar), epoch)                
            writer.add_scalar('Validation bpc', loss_scalar/math.log(2), epoch) 
